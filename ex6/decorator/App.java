...
public class App {
	public static void main(String[] args) {
		...
		Beverage beverageWithTwoMilksAndSugar = new SugarDecorator(new MilkDecorator(new MilkDecorator(new PlainBeverage())));
        System.out.println("You order " + beverageWithTwoMilksAndSugar.getDescription());
        System.out.println("The cost is " + beverageWithTwoMilksAndSugar.getCost());
	}
}
